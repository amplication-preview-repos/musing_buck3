...
@InputType()
class CamperUpdateInput {
  @ApiProperty({
    required: false,
    type: () => BookingUpdateManyWithoutCampersInput,
  })
  @ValidateNested()
  @Type(() => BookingUpdateManyWithoutCampersInput)
  @IsOptional()
  @Field(() => BookingUpdateManyWithoutCampersInput, {
    nullable: true,
  })
...
export { CamperUpdateInput as CamperUpdateInput };
