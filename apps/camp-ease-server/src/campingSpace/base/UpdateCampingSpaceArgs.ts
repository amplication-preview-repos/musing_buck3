...
class UpdateCampingSpaceArgs {
  ...
  @ApiProperty({
    required: true,
    type: () => CampingSpaceUpdateInput,
  })
  @ValidateNested()
  @Type(() => CampingSpaceUpdateInput)
  @Field(() => CampingSpaceUpdateInput, { nullable: false })
  data!: CampingSpaceUpdateInput;
}

export { UpdateCampingSpaceArgs as UpdateCampingSpaceArgs };
